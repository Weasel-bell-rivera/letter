Shader "W1/Environment/CaveRockSurface2D"
{
    Properties
    {
        _BaseColor ("Base Color", Color) = (0.2, 0.12, 0.06, 1)
        _DarkColor ("Dark Color", Color) = (0.08, 0.04, 0.02, 1)
        _TextureScale ("Texture Scale", Range(1, 20)) = 6
        _Variation ("Variation", Range(0, 1)) = 0.25
        _Wetness ("Wet Streaks", Range(0, 1)) = 0.15
        _Strata ("Strata", Range(0, 1)) = 0.12
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings input) : SV_Target
            {
                ...
                return half4(lerp(_DarkColor.rgb, _BaseColor.rgb, tone), 1);
            }
            ENDHLSL
        }
    }

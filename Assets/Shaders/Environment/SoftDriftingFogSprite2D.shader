Shader "W1/Environment/SoftDriftingFogSprite2D"
{
    Properties
    {
        [PerRendererData] _MainTex ("Soft Mask", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings input) : SV_Target
            {
                ...
                return half4(_Color.rgb * input.color.rgb, _Color.a * input.color.a * _Opacity * fog * vertical * mask);
            }
            ENDHLSL
        }
    }

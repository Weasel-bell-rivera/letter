...
- 计划Scene：`Assets/Scenes/Levels/Snow/Snow_012.unity`
- 当前状态：已创建并登记到Build Settings

## 灰盒实现记录

- 房间名称：冰面落雪
- 主要目标：在冰面惯性与落雪周期之间规划路线
- 多阶段内容：
   - 阶段1：控制进入第一段寒冰的速度并穿过左暴露区。
   - 阶段2：在中部FreezingGround控制冻结量并利用普通地形恢复。
   - 阶段3：穿过第二暴露区并到达上层出口。
- 使用机制：PeriodicSnowfall2D、FrozenGround

...
- 计划Scene：`Assets/Scenes/Levels/Snow/Snow_013.unity`
- 当前状态：已创建并登记到Build Settings

## 灰盒实现记录

- 房间名称：分路避雪
- 主要目标：Player与MirrorClone在落雪下控制双板门
- 多阶段内容：
   - 阶段1：Player与MirrorClone分别占据Plate-1和Plate-2。
   - 阶段2：在落雪暴露区引导Enemy-A进入寒冰形成踏板。
   - 阶段3：维持门控状态并利用冻结踏板到达上层分支出口。
- 使用机制：PeriodicSnowfall2D、双压力板、双门、FrozenGround

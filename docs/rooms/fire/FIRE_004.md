...
两个来源入口与出口保持至少1 unit边缘净距，保留门、锁存板和投火者的相互位置。返回流程仍有设计冲突：关闭门挡住投火者对门后Player的视线；本轮没有给门或投火者增加穿墙感应。

| 入口ID | Player Collider中心 |
|---|---|
| `DEFAULT` | `(-9.5,-1.08)` |
| `FROM_FIRE_005` | `(9.45,0.92)` |
| `FROM_FIRE_003` | `(-9.5,-1.08)` |

| 已实现出口 | 中心 | 目标Scene/入口ID |
|---|---|---|
| `Exit-Back-to-FIRE003` | `(-11.5,-1.1)` | `Fire_003/FROM_FIRE_004` |
| `Exit-To-FIRE005` | `(11.5,0.9)` | `Fire_005/FROM_FIRE_004` |
